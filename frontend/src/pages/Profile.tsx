  ...
  return (
    <div className="space-y-6" data-testid="profile-page">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-300">Profile & Settings</h1>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-1">
                    <div className="text-center">
                      ...
                      />
                      <h2 className="mt-4 text-xl font-semibold text-gray-900 dark:text-gray-300">{profile.name || profile.login}</h2>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-block mt-4 px-4 py-2 bg-gray-900 dark:bg-gray-800 text-white rounded-lg hover:bg-gray-800 dark:bg-gray-800 transition-colors"
                      >
                        View on GitHub
                      </a>
                    </div>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-center">
                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-300">{profile.followers}</div>
                        <div className="text-xs text-gray-500">Followers</div>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-center">
                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-300">{profile.following}</div>
                        <div className="text-xs text-gray-500">Following</div>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-center">
                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-300">{profile.public_repos}</div>
                        <div className="text-xs text-gray-500">Public Repos</div>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-center">
                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-300">{profile.public_gists}</div>
                  ...
                  <div className="md:col-span-2 space-y-6">
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Details</h3>
                      <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {profile.company && (
                          <div>
                            <dt className="text-sm text-gray-500">Company</dt>
                            <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{profile.company}</dd>
                          </div>
                        )}
                        {profile.location && (
                          <div>
                            <dt className="text-sm text-gray-500">Location</dt>
                            <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{profile.location}</dd>
                          </div>
                        )}
                        {profile.email && (
                          <div>
                            <dt className="text-sm text-gray-500">Email</dt>
                            <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{profile.email}</dd>
                          </div>
                        )}
                        {profile.blog && (
                          <div>
                        ...
                        <div>
                          ...
                          <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{formatDate(profile.created_at)}</dd>
                        </div>
                      </dl>
                    </div>

                    <div className="border-t pt-6">
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Account</h3>
                      <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <dt className="text-sm text-gray-500">Private Repos</dt>
                          <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{profile.owned_private_repos || 0}</dd>
                        </div>
                        <div>
                          <dt className="text-sm text-gray-500">Disk Usage</dt>
                          <dd className="text-sm font-medium text-gray-900 dark:text-gray-300">{formatDiskUsage(profile.disk_usage || 0)}</dd>
                        </div>
                        <div>
                        ...
                        {profile.plan && (
                          <div>
                            ...
                            <dd className="text-sm font-medium text-gray-900 dark:text-gray-300 capitalize">{profile.plan.name}</dd>
                          </div>
                        )}
                      </dl>
                    </div>
              ...
              {activityLoading ? (
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Activity by Type */}
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Activity by Type</h3>
                    ...
                    {/* Activity by Day */}
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Activity by Day</h3>
                      <ResponsiveContainer width="100%" height={250}>
                  ...
                  {/* Activity Types List */}
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Event Breakdown</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {activity.byType.map((item, idx) => (
                        <div key={item.type} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
          ...
          {activeTab === 'rate-limit' && (
            <div>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300">API Rate Limits</h3>
                <button
              ...
              {rateLimitLoading ? (
                ...
                <div className="space-y-6">
                  {Object.entries(rateLimit.resources).map(([name, limits]) => (
                    <div key={name} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-medium text-gray-900 dark:text-gray-300 capitalize">{name} API</h4>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <div className="text-2xl font-bold text-gray-900 dark:text-gray-300">{limits.used}</div>
          ...
          {activeTab === 'preferences' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Display Preferences</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Show Avatars</label>
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.showAvatars ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-800'
                      }`}
                    >
                      <span
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.compactMode ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-800'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white dark:bg-gray-800 transition-transform ${
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Default Items Per Page</label>
                    <select
                      value={preferences.defaultPerPage}
                      onChange={(e) => setPreferences({ ...preferences, defaultPerPage: parseInt(e.target.value) })}
                      className="w-full md:w-48 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg"
                    >
              ...
              <div className="border-t pt-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-300 mb-4">Data</h3>
                <button
                  onClick={() => {
